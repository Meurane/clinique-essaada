---
title: "Carte Chifa et dialyse en Algérie : le guide pas-à-pas avant chaque séance"
excerpt: "Vérifier vos droits Chifa, recharger la carte, monter le dossier ALD : le guide complet pour éviter tout blocage avant votre séance d'hémodialyse."
date: "2025-09-16"
category: "Démarches"
...
## Avant chaque séance : 3 vérifications utiles
...
## La recharge de la carte Chifa

Le mot "recharge" prête à confusion. **Recharger une carte Chifa, ce n'est pas y mettre du crédit comme une carte de téléphone.** Il s'agit de **mettre à jour les droits** stockés sur la puce, pour qu'elle reflète votre situation actuelle auprès de la CNAS ou de la CASNOS.

Quand cette mise à jour est-elle nécessaire ?

- **Changement d'employeur** : votre nouveau patron doit vous déclarer, et vos droits doivent être réactivés sur la nouvelle base.
- **Passage à la retraite** : votre statut change, votre couverture aussi.
- **Bascule entre CNAS et CASNOS** (par exemple, vous quittez un emploi salarié pour vous mettre à votre compte).
- **Renouvellement de l'ALD** : si votre reconnaissance arrive à terme, il faut la renouveler pour que la prise en charge à 100 % continue.
- **Mise à jour annuelle de routine** demandée par votre agence.

Où faire la **recharge de la carte Chifa** ? À l'agence CNAS ou CASNOS de votre wilaya, sur les bornes prévues à cet effet ou au guichet. À Sidi Bel Abbès comme ailleurs, l'agence locale reste votre interlocutrice. Pour savoir si votre carte est à jour, le plus simple est de la passer sur une borne de mise à jour, ou de demander à votre pharmacien habituel : si la carte est lue correctement et que vos droits s'affichent, tout va bien.

## L'ALD insuffisance rénale terminale : la prise en charge à 100 %

L'[insuffisance rénale chronique terminale](/glossaire/insuffisance-renale-chronique-terminale) fait partie des affections lourdes pour lesquelles la sécurité sociale algérienne reconnaît une ALD, ouvrant droit à une prise en charge à 100 % de la dialyse et des soins associés. Faire reconnaître cette ALD est donc une étape clé de votre parcours.

**Qui initie la demande ?** Votre médecin traitant ou votre néphrologue. C'est lui qui rédige le certificat médical détaillé décrivant la pathologie, le stade de la maladie et la nécessité du traitement par dialyse.

**Quels documents en règle générale ?**

- Le formulaire de demande d'ALD fourni par la CNAS ou la CASNOS.
- Un certificat médical détaillé du médecin traitant.
- Les comptes-rendus utiles : bilans biologiques, comptes-rendus de néphrologie, parfois imagerie.
- Une copie de votre carte Chifa et de votre pièce d'identité.

**À qui dépose-t-on le dossier ?** À la commission médicale de votre caisse (CNAS ou CASNOS, selon votre statut). C'est cette commission qui valide la reconnaissance ALD.

Une fois la reconnaissance acquise, la prise en charge n'est pas figée pour toujours : elle se **renouvelle périodiquement**. Mieux vaut anticiper le renouvellement plutôt que de découvrir à la séance que votre ALD a expiré.

## Les blocages les plus fréquents — et comment les anticiper

| Le blocage | La conséquence | L'action préventive |
|---|---|---|
| **Carte Chifa expirée** | Lecture impossible, tiers-payant suspendu | Vérifier la date sur la carte, renouveler en agence |
| **Droits non mis à jour après changement de statut** | Carte lue, mais "droits fermés" | Passer en agence dès tout changement (emploi, retraite) |
...
## À la Clinique ESSAADA, comment on vous accompagne

L'administratif, on sait que c'est parfois pénible. Voici comment notre équipe peut vous aider concrètement dans le [parcours d'hémodialyse à ESSAADA](/services/hemodialyse) :

- **Montage du dossier ALD** : si votre reconnaissance n'est pas encore en place, notre secrétariat peut vous orienter sur les pièces à rassembler et la démarche à suivre avec votre médecin traitant.
- **Tiers-payant intégral** : la clinique est **conventionnée CNAS et CASNOS**, ce qui permet la prise en charge directe sans avance de frais quand votre carte et vos droits sont à jour.
- **Signalement précoce des blocages** : en cas de problème de lecture de la carte ou de droits suspendus, on vous prévient le plus tôt possible et on vous accompagne pour identifier la démarche à entreprendre auprès de votre agence.

Si vous démarrez tout juste votre traitement, jetez un œil à notre page dédiée à la [première séance](/services/premiere-seance) : elle vous donne une vision claire de ce qui vous attend, côté médical comme côté administratif.
